      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className='relative w-full h-[20vh] md:h-[45vh]'>
            ...
            <div className='absolute top-0 left-0 w-full h-full flex justify-center items-center p-2 sm:p-4'>
              <div className='w-full h-full flex justify-center items-center border-2 border-blue-600 border-opacity-70 p-4 box-border gap-2 sm:gap-4'>
                <h1 className='text-white text-3xl sm:text-4xl lg:text-5xl font-bold uppercase tracking-widest pb-1 sm:pb-3 text-border-bottom gradient-text'>About Us</h1>
              </div>
            </div>
          </div>
          ...
          <div className='w-[95%] min-h-[80vh] mx-auto flex flex-col-reverse lg:flex-row justify-center items-center gap-4 sm:gap-6 lg:gap-10 bg-slate-100 my-10 rounded-lg shadow-lg sm:p-6'>
            <div className='w-full h-full lg:w-[60%] p-2 xxs:p-4 sm:p-6 space-y-4'>
              <h2 className='text-2xl xxs:text-3xl lg:text-4xl font-bold text-gray-800 mb-4 border-b-2 border-orange-500 pb-2 xxs:pb-3'>
                About Neotek
              </h2>
              <p className='text-base xxs:text-lg lg:text-xl text-gray-700 leading-relaxed'>
              ...
              <p className='mt-4 text-base xxs:text-lg lg:text-xl text-gray-700 leading-relaxed'>
          ...
          <div className='w-[95%] min-h-[60vh] mx-auto flex flex-col lg:flex-row justify-center items-center gap-4 sm:gap-6 lg:gap-10 bg-white my-10 rounded-lg shadow-lg sm:p-6'>
            <div className='w-full h-full lg:w-[50%] p-2 xxs:p-4 sm:p-6'>
              <h2 className='text-2xl xxs:text-3xl lg:text-4xl font-bold text-gray-800 mb-4 border-b-2 border-green-500 pb-2 xxs:pb-3'>
                Our Mission
              </h2>
              <p className='text-base xxs:text-lg lg:text-xl text-gray-700 leading-relaxed'>
          ...
          <div className='w-[95%] min-h-[60vh] mx-auto flex flex-col lg:flex-row-reverse justify-center items-center gap-4 sm:gap-6 lg:gap-10 bg-white my-10 rounded-lg shadow-lg sm:p-6'>
            <div className='w-full h-full lg:w-[50%] p-2 xxs:p-4 sm:p-6'>
              <h2 className='text-2xl xxs:text-3xl lg:text-4xl font-bold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2 xxs:pb-3'>
                Our Vision
              </h2>
              <p className='text-base xxs:text-lg lg:text-xl text-gray-700 leading-relaxed'>
