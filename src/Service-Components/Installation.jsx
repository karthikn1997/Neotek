...
const Installation = () => {
  return (
    <div className="w-full bg-gray-100 flex justify-center items-center py-8 xxs:py-16 px-4 xxs:px-6 ">
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-2 xxs:space-y-6 md:pr-8">
          <h1 className="text-2xl xxs:text-3xl md:text-5xl font-bold text-gray-800 leading-snug">
            Support from <span className='text-[#37689F]'>Installation to Insight</span>
          </h1>
          <p className="text-base xxs:text-lg md:text-xl  text-gray-600 leading-relaxed">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-600 text-sm xxs:text-md md:text-lg ">
