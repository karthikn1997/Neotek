    ...
    <div className='w-full h-[80vh]  relative mt-8'>
      ...
      >
        <div className='flex flex-col gap-3 items-center justify-center w-full h-full absolute top-0 left-0 '>
          <div className='flex flex-col justify-evenly text-center text-white p-4 bg-black bg-opacity-50 rounded-3xl w-[90%] lg:w-[70%] py-10 border-x-8 border-white px-4 xxs:px-8 lg:px-20' data-aos="fade-right">
            {/* Updated font style here */}
            <h1 className=' text-2xl xxs:text-3xl sm:text-5xl font-bold font-[Cinzel] text-white mb-8 tracking-wider capitalize' data-aos="slide-right" data-aos-delay="300">
            ...
            <button onClick={() => navigate('/contact')} className="w-full xxs:w-[80%] sm:w-[40%] mx-auto bg-gradient-to-r from-blue-900 via-black to-black hover:bg-gradient-to-l text-white font-semibold py-2 sm:py-3 px-8 rounded-xl transition duration-300 border-[2px] border-white whitespace-nowrap" data-aos="flip-left" data-aos-delay="300">
