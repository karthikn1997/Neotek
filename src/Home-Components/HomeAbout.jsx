...
const HomeAbout = () => {
    ...
    return (
        <div className='w-full min-h-[60vh] flex flex-col lg:flex-row justify-center items-center overflow-hidden'>
            <div className='w-full lg:w-[50%] h-[40vh] sm:h-[60vh] bg-[#37689F] flex flex-col justify-center items-center'>
                <div className='w-full md:w-[70%] p-6 md:p-0 flex flex-col justify-center items-center lg:justify-start lg:items-start'>
                    ...
                    <p className='text-white my-4 sm:my-6 text-center lg:text-left text-sm md:text-lg lg:text-xl'>Innovative sorting solutions for industries worldwide, ensuring precision and efficiency in every operation. Empowering businesses with cutting-edge technology for a sustainable future.</p>
